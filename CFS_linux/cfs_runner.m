function [ ] = cfs_runner(x1, x2, y1, y2, warmup, NoWarmups, noise_start_interval, noise_random_interval, fade_rate, refresh_rate, bgcolor, noise_data, fixation_cross_color, noise_coord, info_coord, info_brd_coord, brd_coord, disparity, TimeOut, stimulus_loc, randTrial, audioTiming, audioOff, answerKeys, responseDelay)
