function run_experiment
    ...
    try
        ...
        responseDelay = stimuli_parameters(80);
        ...
        cfs_runner(w_x1, w_x2, w_y1, w_y2, warmup, NoWarmups, noise_start_interval, noise_random_interval, fade_rate, refresh_rate, bgcolor, noise_data, fixation_cross_color, noise_coord, info_coord, info_brd_coord, brd_coord, disparity, TimeOut, stimulus_loc, randTrial, audioTiming, audioOff, answerKeys, responseDelay);
